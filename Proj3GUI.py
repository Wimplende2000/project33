...
# source or target node
    ...
    def initUI(self):
        ...
        self.arrayTime.setReadOnly(True)  # Make arrayTime read-only
        self.heapTime = QLineEdit('')
        self.heapTime.setFixedWidth(120)
        self.heapTime.setReadOnly(True)  # Make heapTime read-only
        self.speedup = QLineEdit('')
        self.speedup.setFixedWidth(200)
        self.speedup.setReadOnly(True)  # Make speedup read-only
        ...
        self.totalCost.setReadOnly(True)  # Make totalCost read-only
